...
import { WorkforceProfile, EmployerMatch, OutreachAssets, SocialPost, Step } from './types';
import { enhanceProfile, discoverEmployers, generateOutreach, generateSocialCalendar, generatePostGraphic, generateSpeech, getSupportExpertResponse } from './geminiService';
...
const AIDisclaimer = () => (
  <div className="flex items-start gap-2 text-[10px] text-slate-400 mt-4 bg-slate-50/50 p-3 rounded-xl border border-slate-100">
    <TriangleAlert size={14} className="shrink-0 text-slate-400 mt-0.5" />
    <p className="leading-relaxed">
      Employer data and recommendations are generated by AI and may be incomplete or inaccurate. Always verify employer information directly. This platform does not endorse any employer or guarantee partnership outcomes.
    </p>
  </div>
);
...
const TermsContent = () => (
  <div className="space-y-8 font-mono text-[11px] leading-relaxed text-slate-700">
    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">1. Overview of B2B SaaS Service</h3>
      <p>
        The Employer Engagement Engine (E^3) is a Business-to-Business (B2B) Software-as-a-Service (SaaS) platform designed for community colleges, workforce development entities, and enterprise organizations. E^3 provides automated market discovery, outreach asset generation, and multi-channel campaign planning through the integration of proprietary logic and generative artificial intelligence. This service is intended strictly for commercial and institutional use, not for individual consumers.
      </p>
    </section>

    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">2. Eligibility and Authorized Use</h3>
      <p>
        Access to and use of the E^3 platform is strictly limited to authorized users who are 18 years of age or older and are acting on behalf of a recognized community college, workforce development entity, or enterprise organization. By accessing the platform, you represent and warrant that you meet these eligibility requirements. Use of this service by minors or any unauthorized individuals is expressly prohibited.
      </p>
    </section>

    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">3. AI Usage & Accuracy</h3>
      <p>
    ...
    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">4. Compliance & Fair Hiring</h3>
      <p>
    ...
    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">5. No Guarantee of Outcomes</h3>
      <p>
    ...
    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">6. Data Sensitivity</h3>
      <p>
    ...
    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">7. Intellectual Property</h3>
      <p>
    ...
    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">8. GDPR & Geographic Restrictions</h3>
      <p>
    ...
    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">9. CCPA & State Data Broker Compliance</h3>
      <p>
    ...
    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">10. B2B SaaS Account & Subscription</h3>
      <p>
        As a B2B SaaS platform, access to E^3 requires an active subscription or authorized organizational account. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. We reserve the right to suspend or terminate accounts that violate these terms or engage in unauthorized use of the platform.
      </p>
    </section>

    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">11. Employer Data Sourcing & Usage Restrictions</h3>
      <p>
        E^3 aggregates employer data from various public sources, job boards, professional networks, and business directories. We do not guarantee the accuracy, completeness, or current validity of this aggregated data.
      </p>
      <ul className="list-disc pl-5 space-y-2">
        <li><strong>Data Accuracy:</strong> Employer contact information, hiring status, and organizational details may change frequently. Users should verify all information before initiating outreach.</li>
        <li><strong>Platform Terms of Service:</strong> Users are strictly prohibited from utilizing scraped or aggregated contact data in any manner that violates the Terms of Service of the originating source platforms.</li>
        <li><strong>User Responsibility:</strong> Users assume full responsibility for ensuring their outreach and data usage practices comply with all applicable platform policies, anti-spam laws, and legal regulations.</li>
      </ul>
    </section>

    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">12. WIOA & Department of Labor Compliance</h3>
      <p>
        The E^3 platform does not filter, rank, or prioritize employers in any manner that produces discriminatory outcomes based on race, gender, disability status, or any other protected class.
      </p>
      <p>
        Users are strongly recommended to ensure that their employer partnership selection processes, outreach strategies, and subsequent placements comply with their own Workforce Innovation and Opportunity Act (WIOA) obligations, Department of Labor regulations, and institutional Equal Opportunity plans.
      </p>
      <ul className="list-disc pl-5 space-y-2">
        <li><strong>AI Recommendations:</strong> Employer recommendations generated by AI are for informational use only and do not constitute compliance or legal guidance.</li>
        <li><strong>Partner Vetting:</strong> Users should independently vet employer partners for compliance with applicable apprenticeship Equal Employment Opportunity (EEO) standards and other regulatory requirements.</li>
      </ul>
    </section>

    <section className="space-y-4">
      <h3 className="text-slate-900 font-black uppercase text-xs border-b border-slate-100 pb-2">13. Data Security & Breach Notification</h3>
      <p>
        Because E^3 stores organizational user data and employer contact records server-side, we maintain rigorous security practices to protect this information.
      </p>
      <ul className="list-disc pl-5 space-y-2">
        <li><strong>Access Controls:</strong> We enforce strict role-based access controls (RBAC) and authentication mechanisms to ensure that only authorized personnel can access sensitive system infrastructure and data.</li>
        <li><strong>Incident Response & Breach Notification:</strong> In the event of a confirmed data breach compromising organizational or employer data, E^3 will activate its incident response protocol. We are committed to notifying affected users and relevant authorities within 30 to 72 hours of confirming a breach, in compliance with applicable state and federal breach notification laws.</li>
      </ul>
    </section>
  </div>
);
...
const App: React.FC = () => {
  ...
  const [activeModal, setActiveModal] = useState<{ type: 'followups' | 'script' | 'social'; employer: string } | null>(null);
  const [settingsModal, setSettingsModal] = useState<'export' | 'delete' | null>(null);
  ...
  const progress = useMemo(() => {
    ...
    const linearSteps: Step[] = ['intake', 'discovery', 'report', 'outreach', 'social', 'dashboard'];
  ...
  const dashboardStats = useMemo(() => {
    ...
    const socialReady = socialPosts.length;
  ...
  }, [matches, outreachData, socialPosts]);
    ...
    try {
      ...
      if (navigator.share && navigator.canShare && navigator.canShare({ files: [file] })) {
        ...
        try {
          ...
          alert("Sharing not natively supported in this browser, but we've COPIED the image to your clipboard! You can now paste it directly into your Social feed.");
        } catch (copyErr) {
  ...
  const handleCopyAllSocialPosts = () => {
    if (socialPosts.length === 0) return;
    const allText = socialPosts.map((p, i) => `[POST ${i+1} - ${p.pillar}]\n${p.content}\n${p.hashtags.map(h => `#${h}`).join(' ')}`).join('\n\n---\n\n');
    navigator.clipboard.writeText(allText);
    alert("All generated social posts copied to clipboard!");
  };

  const handleUpdatePost = (index: number, updates: Partial<SocialPost>) => {
    setSocialPosts(prev => {
      const next = [...prev];
  ...
  // Implement ActionButtons component used in outreach and social views
  ...
  // Implement handleGenerateSocial for post generation
  const handleGenerateSocial = async () => {
    if (!profile) return;
    setLoading(true);
    try {
      const posts = await generateSocialCalendar(profile);
      setSocialPosts(posts);
    } catch (err) {
      console.error(err);
      alert("Failed to generate social strategy.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleGenerateGraphic = async (index: number) => {
    if (!profile || !socialPosts[index]) return;
    setGeneratingImages(prev => ({ ...prev, [index]: true }));
    try {
      const url = await generatePostGraphic(socialPosts[index], profile);
        ...
        contents: `You are the E^3 Strategy Assistant, acting as a high-end Talent Scout and Strategic Partnership Manager. 
          ...
          4. Use Bullet Points (* ) for:
             ...
             - **Warm Lead Entry Point:** List a specific name and title found via search. 
               * *Fallback Logic:* If no name is found, provide the precise Social search query for the most likely decision-maker (e.g., "Search for: 'Director of HR at [Company Name]'").
  ...
  const isWorkflowActive = ['intake', 'discovery', 'report', 'outreach', 'social', 'dashboard'].includes(step);
  ...
  return (
        ...
        >
          ...
          <nav className="flex-1 p-4 space-y-2 overflow-y-auto overflow-x-hidden no-scrollbar">
            {[
              ...
              { id: 'social', icon: Share2, label: '5. Network Builder', requiresProfile: true },
            ...
            <section className="bg-slate-900 text-white py-20 md:py-32 lg:py-40 px-6 md:px-12 relative overflow-hidden flex flex-col items-center justify-center min-h-[90vh]">
              ...
              <div className="max-w-6xl mx-auto relative z-10 text-center space-y-10 md:space-y-14">
                ...
                <p className="text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-12 duration-700 delay-200">
                  Employer Engagement Engine (E³), helping Workforce Programs Find, Engage, and Grow Employer Partners.
                </p>
              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative">
                  ...
                  {[
                    ...
                    { icon: Search, title: 'Discovery', desc: 'Scan local markets for employer matches.', color: 'indigo' },
                    ...
                    { icon: Share2, title: 'Visibility', desc: 'Scale social media content for local impact.', color: 'sky' },
                  ].map((s, i) => (
            ...
            <section id="pricing" className="py-24 px-8 bg-slate-50 relative border-t border-slate-200">
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16 space-y-4">
                  <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">See E^3 in Action</h2>
                  <p className="text-xl text-slate-500 max-w-2xl mx-auto font-medium">Find the right employers to partner with — instantly. Schedule a quick demo to see the platform in action.</p>
                </div>
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-8 md:p-12">
                  <form 
                    onSubmit={(e) => {
                      ...
                      const orgName = formData.get('orgName') || 'Not provided';
                      const industry = formData.get('industry');
                      const email = formData.get('email');
                      const phone = formData.get('phone') || 'Not provided';

                      const subject = encodeURIComponent(`Demo Request: ${firstName} ${lastName}`);
                      const body = encodeURIComponent(`Name: ${firstName} ${lastName}\nOrganization: ${orgName}\nIndustry: ${industry}\nEmail: ${email}\nPhone: ${phone}\n\nI would like to schedule a quick demo to see E^3 in action.`);

                      window.open(`mailto:sales@edgefactoryai.com?subject=${subject}&body=${body}`, '_blank');
                    }}
                    className="space-y-6"
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label htmlFor="firstName" className="block text-xs font-bold text-slate-700 uppercase tracking-widest">First Name *</label>
                        <input required type="text" id="firstName" name="firstName" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" placeholder="Jane" />
                      </div>
                      <div className="space-y-2">
                        <label htmlFor="lastName" className="block text-xs font-bold text-slate-700 uppercase tracking-widest">Last Name *</label>
                        <input required type="text" id="lastName" name="lastName" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" placeholder="Doe" />
                      </div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label htmlFor="orgName" className="block text-xs font-bold text-slate-700 uppercase tracking-widest">Organization Name</label>
                        <input type="text" id="orgName" name="orgName" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" placeholder="Acme Corp" />
                      </div>
                      <div className="space-y-2">
                        <label htmlFor="industry" className="block text-xs font-bold text-slate-700 uppercase tracking-widest">Industry *</label>
                        <input required type="text" id="industry" name="industry" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" placeholder="Technology" />
                      </div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label htmlFor="email" className="block text-xs font-bold text-slate-700 uppercase tracking-widest">Email Address *</label>
                        <input required type="email" id="email" name="email" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" placeholder="jane@example.com" />
                      </div>
                      <div className="space-y-2">
                        <label htmlFor="phone" className="block text-xs font-bold text-slate-700 uppercase tracking-widest">Phone Number</label>
                        <input type="tel" id="phone" name="phone" className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" placeholder="(555) 123-4567" />
                      </div>
                    </div>
                    ...
                    <div className="pt-4">
                      <button 
                        type="submit"
                        className="w-full inline-flex items-center justify-center px-8 py-4 bg-blue-600 text-white rounded-xl font-black text-sm tracking-widest shadow-lg shadow-blue-900/20 hover:bg-blue-700 transition-colors uppercase"
                      >
                        Request Demo
                      </button>
                    </div>
            ...
            <div className="space-y-8 animate-in fade-in duration-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  { label: 'Social Assets', value: dashboardStats.socialReady, icon: Share2, color: 'sky', desc: 'Social templates' }
                ].map((stat, i) => (
    ...
    <div className="flex items-center gap-6">
                      ...
                      {outreachData[match.name] ? (
                        <div className="space-y-5">
                          <div className="grid grid-cols-1 gap-2.5">
                            ...
                            <button 
                              type="button"
                              onClick={() => setActiveModal({ type: 'social', employer: match.name })}
                              className="flex items-center justify-between p-4 bg-slate-50 hover:bg-slate-100 rounded-2xl border border-slate-100 transition-colors group/item"
                            >
                              <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm text-blue-600">
                                ...
                                <div className="text-left">
                                  ...
                                  <p className="text-sm font-bold text-slate-900">Tailored Social DM</p>
                                </div>
                              </div>
                              <ChevronRight size={18} className="text-slate-300 group-hover/item:text-blue-500 group-hover/item:translate-x-1 transition-all" />
                            </button>
            ...
            <div className="space-y-8 animate-in fade-in duration-700 pb-16">
              <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tight">Step 5: Network Builder</h2>
                ...
                <div className="flex flex-wrap gap-3 w-full md:w-auto">
                  ...
                  {socialPosts.length > 0 && (
                    <button 
                      type="button"
                      onClick={handleCopyAllSocialPosts}
              ...
              {socialPosts.length === 0 ? (
                <div className="bg-white rounded-[2.5rem] p-16 text-center border border-slate-200 shadow-sm space-y-6">
                  ...
                  <p className="text-slate-500 max-w-md mx-auto font-medium">Click the button above to generate 10 unique, ROI-focused Social posts tailored to your program's goals and target industries.</p>
                </div>
              ) : (
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-12">
                        <div className="lg:col-span-7 p-8 lg:p-10 space-y-6">
                          ...
                          <div className="pt-6 flex flex-wrap gap-4">
                            ...
                            <ActionButtons text={post.content} label={`Social Post ${idx + 1}`} />
                          </div>
                        </div>
                  ...
                  {supportMessages.length === 0 && (
                    <div className="h-full flex flex-col items-center justify-center text-center space-y-6 px-6 max-w-3xl mx-auto py-8">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-slate-500 text-xs font-medium leading-relaxed">
                          Ask me anything about how E^3 works, how to manage partnerships, or how to build your Social strategy.
                        </p>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full max-w-xl">
                        {[
                          ...
                          'How do I generate Social graphics?',
            ...
            <div className="flex flex-col flex-1 animate-in fade-in duration-700 overflow-hidden bg-slate-50 md:border md:border-slate-200 md:rounded-[2rem] md:shadow-sm px-4 md:px-8 pt-4 md:pt-8">
              <header className="p-4 md:p-6 border-b border-slate-100 flex items-center justify-between shrink-0 bg-white">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="font-black text-slate-900 uppercase text-xs tracking-[0.15em]">Account Settings</h2>
                </div>
                <button 
                  type="button"
                  onClick={() => setStep(profile ? 'discovery' : 'landing')} 
                  className="flex items-center gap-2 text-[10px] font-black text-slate-600 hover:text-slate-900 uppercase transition-colors"
                >
                  <ArrowLeft size={14} /> Back
                </button>
              </header>
              
              <div className="flex-1 overflow-y-auto p-6 md:p-12 space-y-8 min-h-0 bg-white no-scrollbar">
                <div className="max-w-3xl mx-auto space-y-12">
                  
                  <section className="space-y-6">
                    <div className="border-b border-slate-100 pb-4">
                      <h3 className="text-lg font-black text-slate-900 uppercase tracking-widest">Stored Data Overview</h3>
                      <p className="text-sm text-slate-500 mt-2">Review the information currently stored for your account.</p>
                    </div>
                    
                    <div className="bg-slate-50 rounded-2xl p-6 border border-slate-100 space-y-6">
                      <div>
                        <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-3">Account Information</h4>
                        <div className="grid grid-cols-1 gap-4">
                          <div className="bg-white p-4 rounded-xl border border-slate-100">
                            <span className="block text-[10px] uppercase font-bold text-slate-400 mb-1">Email Address</span>
                            <span className="text-sm font-medium text-slate-900">{user?.email || 'Not provided'}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <section className="space-y-6">
                    <div className="border-b border-slate-100 pb-4">
                      <h3 className="text-lg font-black text-slate-900 uppercase tracking-widest">Data Management</h3>
                      <p className="text-sm text-slate-500 mt-2">Export your data or request account deletion.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col justify-between">
                        <div>
                          ...
                          <h4 className="font-black text-slate-900 mb-2">Export Data</h4>
                          <p className="text-xs text-slate-500 mb-6 leading-relaxed">
                            Download a complete archive of your account data, including your profile, saved employers, and generated campaigns in a Word document format.
                          </p>
                        </div>
                        <button 
                          onClick={() => setSettingsModal('export')}
                          className="w-full py-3 bg-slate-900 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-black transition-all active:scale-95"
                        >
                          Request Export
                        </button>
                      </div>

                      <div className="bg-red-50 border border-red-100 rounded-2xl p-6 flex flex-col justify-between">
                        <div>
                          <div className="w-10 h-10 bg-red-100 text-red-600 rounded-xl flex items-center justify-center mb-4">
                            <Ban size={20} />
                          </div>
                          <h4 className="font-black text-red-900 mb-2">Delete Account</h4>
                          <p className="text-xs text-red-700/70 mb-6 leading-relaxed">
                            Permanently delete your account and all associated data. This action cannot be undone and will remove all saved employers and campaigns.
                          </p>
                        </div>
                        <button 
                          onClick={() => setSettingsModal('delete')}
                          className="w-full py-3 bg-red-600 text-white rounded-xl text-xs font-black uppercase tracking-widest hover:bg-red-700 transition-all active:scale-95"
                        >
                          Delete Account
                        </button>
                      </div>
              ...
              <div className="flex-1 overflow-y-auto p-6 md:p-12 space-y-8 min-h-0 bg-white selection:bg-blue-100 no-scrollbar">
                <div className="max-w-3xl mx-auto space-y-8 font-mono text-[11px] leading-relaxed text-slate-700">
                  <section className="space-y-4">
                    ...
                    <p>
                      As a B2B SaaS platform, we collect information you provide directly to us when you create an organizational account, update your profile, or use our interactive features on behalf of your institution or company. This includes:
                    </p>
                    <ul className="list-disc pl-5 space-y-2">
                      <li>Contact information (name, business email address, business phone number)</li>
                      ...
                      <li>Billing and subscription information for your organization</li>
                    </ul>
                  </section>
                  ...
                  <section className="space-y-4">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                      <li>Provide, maintain, and improve the E^3 Engine B2B SaaS services.</li>
                      <li>Generate customized outreach materials and strategic reports for your organization.</li>
                      <li>Communicate with you about products, services, offers, events, and subscription updates.</li>
                      <li>Monitor and analyze trends, usage, and activities in connection with our services to improve platform performance.</li>
                    </ul>
                  </section>
                  ...
                  <section className="space-y-4">
                    ...
                    <p>
                      We do not share your personal or organizational information with third parties except as described in this policy:
                    </p>
                    <ul className="list-disc pl-5 space-y-2">
                      <li>With vendors, consultants, and other service providers who need access to such information to carry out work on our behalf (e.g., payment processors, cloud hosting).</li>
                  ...
                  <section className="space-y-4">
                    ...
                    <p>
                      We take reasonable measures to help protect information about you and your organization from loss, theft, misuse, and unauthorized access, disclosure, alteration, and destruction. As a B2B platform, we prioritize the security of your institutional data.
                    </p>
                  </section>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-800">
                          ...
                          <p>Tailored outreach assets (Email, Call Scripts, Social DMs) are auto-generated based on specific employer ROI segments.</p>
                        </div>
                        <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-800">
                          <p className="font-black text-slate-900 uppercase text-[10px] mb-2">Cycle D: Visibility</p>
                          <p>A 10-post Social content strategy with AI-generated graphics builds regional brand authority for the program.</p>
                        </div>
                      </div>
                    </div>
                  </section>
                    ...
                    <div className="space-y-4">
                      ...
                      <ul className="space-y-4">
                        ...
                        <li className="flex gap-4">
                          ...
                          <p>If an employer match or Social graphic doesn't meet institutional standards, use the "Refresh" or "Regenerate" buttons. The Gemini engine learns from these context switches in a single session.</p>
                        </li>
                      </ul>
                    </div>
                  </section>
                  ...
                  <section className="space-y-6">
                    ...
                    <div className="p-6 bg-blue-50 border border-blue-100 rounded-2xl space-y-4">
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-blue-800 text-[10px]">
                        ...
                        <li>Ensure Social graphics adhere to institutional brand style guides.</li>
                      </ul>
                    </div>
                  </section>
      ...
      {step !== 'landing' && (
        ...
        >
           <div className="flex justify-around items-stretch h-16 max-lg mx-auto px-1">
            ...
            <button 
              type="button" 
              onClick={() => { if(profile) { setStep('social'); stopSpeech(); } }}
              disabled={!profile}
              className={`flex flex-col items-center justify-center w-full h-full gap-1 transition-all outline-none ${!profile ? 'text-slate-300' : (step === 'social' ? 'text-[#0077b5]' : 'text-slate-600')}`}
            >
               <Share2 size={18} />
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col border border-slate-200 animate-in zoom-in-95 duration-200">
            <header className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50 shrink-0">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-blue-100 text-blue-600 rounded-xl">
                  {activeModal.type === 'followups' ? <MailIcon size={20} /> : activeModal.type === 'script' ? <Phone size={20} /> : <Share2 size={20} />}
                </div>
                <div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 no-scrollbar bg-slate-50/30">
              ...
              {activeModal.type === 'social' && (
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                  <div className="flex justify-between items-center mb-4"><span className="text-blue-600 uppercase tracking-widest text-[10px] font-black">Direct Message</span><ActionButtons text={outreachData[activeModal.employer].socialMessage} label="Social Message" /></div>
                  <p className="text-slate-700 leading-relaxed whitespace-pre-wrap italic text-sm font-medium">{outreachData[activeModal.employer].socialMessage}</p>
                </div>
              )}
            </div>
      ...
      {settingsModal === 'export' && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col border border-slate-200 animate-in zoom-in-95 duration-200">
            <header className="p-6 border-b border-slate-100 flex items-center gap-3 bg-slate-50/50">
              <div className="p-2 bg-blue-100 text-blue-600 rounded-xl">
                <Cloud size={20} />
              </div>
              <h3 className="font-black text-slate-900 uppercase text-xs tracking-widest">Export Data</h3>
            </header>
            <div className="p-6 space-y-4">
              <p className="text-sm text-slate-600 leading-relaxed">
                You are about to download a complete archive of your account data in a Word document format. This includes your profile, saved employers, and generated campaigns.
              </p>
            </div>
                ...
                onClick={async () => {
                  const doc = new Document({
                    sections: [{
                      properties: {},
                      children: [
                        new Paragraph({ children: [new TextRun({ text: "Account Data Export", bold: true, size: 32 })] }),
                        new Paragraph({ children: [new TextRun({ text: `Email: ${user?.email || 'Not provided'}` })] }),
                        new Paragraph({ children: [new TextRun({ text: "Profile Information", bold: true, size: 24 })] }),
                        ...JSON.stringify(form, null, 2).split('\n').map(line => new Paragraph({ children: [new TextRun(line)] })),
                        new Paragraph({ children: [new TextRun({ text: "Saved Employers", bold: true, size: 24 })] }),
                        ...Array.from(selectedEmployers).map(emp => new Paragraph({ children: [new TextRun(emp)] })),
                        new Paragraph({ children: [new TextRun({ text: "Campaigns", bold: true, size: 24 })] }),
                        ...JSON.stringify(outreachData, null, 2).split('\n').map(line => new Paragraph({ children: [new TextRun(line)] })),
                      ],
                    }]
                  });

                  const blob = await Packer.toBlob(doc);
                  saveAs(blob, "e3_account_data_export.docx");
                  setSettingsModal(null);
                }} 
                className="px-6 py-2.5 bg-blue-600 text-white rounded-xl font-bold text-sm shadow-lg hover:bg-blue-700 transition-colors"
              >
                Download Report
              </button>
            </footer>
      ...
      {settingsModal === 'delete' && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col border border-slate-200 animate-in zoom-in-95 duration-200">
            <header className="p-6 border-b border-slate-100 flex items-center gap-3 bg-red-50/50">
              <div className="p-2 bg-red-100 text-red-600 rounded-xl">
                <Ban size={20} />
              </div>
              <h3 className="font-black text-red-900 uppercase text-xs tracking-widest">Delete Account</h3>
            </header>
            <div className="p-6 space-y-4">
              <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <div className="bg-red-50 p-4 rounded-xl border border-red-100">
                <p className="text-xs text-red-800 font-bold">
                  This action cannot be undone. All saved employers, campaigns, and profile data will be permanently removed.
                </p>
              </div>
            </div>
            <footer className="p-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-3 shrink-0">
              ...
              <button 
                ...
                onClick={async () => {
                  try {
                    ...
                    alert("Failed to delete account. You may need to sign in again before deleting your account.");
                  }
                }} 
                className="px-6 py-2.5 bg-red-600 text-white rounded-xl font-bold text-sm shadow-lg hover:bg-red-700 transition-colors"
              >
                Permanently Delete
              </button>
            </footer>
